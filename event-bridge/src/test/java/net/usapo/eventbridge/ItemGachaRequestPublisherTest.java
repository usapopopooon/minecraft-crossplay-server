...
final class ItemGachaRequestPublisherTest {
    @Test
    void publishesVersionedRequestWithStableIdentityKindAndTimestamp() {
        ...
        ItemGachaRequestPublisher publisher = new ItemGachaRequestPublisher(
                messages::add,
